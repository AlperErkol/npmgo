        ...
        <header className='header bg-default-sidebarColor w-full mb-4 py-2'>
            <form onSubmit={(e)=>onSubmitHandler(e)}>
                <div className='relative inline pl-40'>
                    <input className='search-input bg-default-inputColor text-default-whitely py-2 px-4 w-1/3 rounded-md [outline:0]' type="text" placeholder='Search for npm packages' onChange={(e)=>onChangeHandler(e.target)}/>
